    ...
    return (
      <React.Fragment>
        <div className="privacy-body">
          <h1> Privacy Policy for knoxhutchinson.com </h1>
          <p>
            {" "}
          ...
          <p>
            {" "}
            At knoxhutchinson.com, the privacy of our visitors is of extreme
            importance to us. This privacy policy document outlines the types of
            personal information is received and collected by knoxhutchinson.com
            and how it is used.{" "}
          </p>
          <p>
            {" "}
            <b>Log Files</b>
            <br /> Like many other Web sites, knoxhutchinson.com makes use of
            ...
            of clicks to analyze trends, administer the site, track users
          ...
          <p>
            ...
            <br /> knoxhutchinson.com does use cookies to store information
            about visitors preferences, record user-specific information on
            which pages the user access or visit, customize Web page content
          ...
          <p>
            ...
            users based on their visit to knoxhutchinson.com and other sites on
            the Internet. <br />
          ...
          <p>
            ...
            advertisements and links that appear on knoxhutchinson.com send
          ...
          <p>
            {" "}
            knoxhutchinson.com has no access to or control over these cookies
          ...
          <p>
            ...
            certain practices. knoxhutchinson.com's privacy policy does not
